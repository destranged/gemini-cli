...
echo "3. Local Ollama"
echo "4. MS Azure API"
echo "5. Local LLM (custom endpoint)"
echo "6. All of the above (for testing)"
...
case $choice in
    ...
    5)
        ...
        read -p "Enter model name (default ShcCodeAssistant): " model
        ...
        echo "LOCAL_LLM_MODEL=$model" >> .env
